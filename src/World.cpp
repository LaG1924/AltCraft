        ...
        { //Horizontal velocity
            ...
            if(!collided->empty()){
				...
				for(size_t i=0; i!=collided->size(); i++){
                    ...
                    float ta=(it.pos.x-B.x-0.5);
                    float tb=(newPos.x-B.x-0.5);
					...
					if(ta==0||tb==0){
                        ...
                        tb=(newPos.z-B.z-0.5)/tb;
                        ta=(it.pos.z-B.z-0.5)/ta;
					if(ta>tb){
